 ...
 * @author FPT
 */
@WebServlet("/admin-search-account")
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            if (!search.trim().isEmpty()) {
                users = adminDAO.searchAccountsByFullName(search);
            } else {
                users = adminDAO.getAllAccounts();
            }
            ...
            request.setAttribute("message", "Error loading accounts!");
