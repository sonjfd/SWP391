...
public class ListBreed extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ListBreed</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ListBreed at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            e.printStackTrace();
            request.setAttribute("message", "Failed to load breed list.");
            request.getRequestDispatcher("view/admin/content/ListBreed.jsp").forward(request, response);
        }
    } 
