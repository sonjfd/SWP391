 ...
 * @author Dell
 */
@WebServlet(name="Appointmentdetail", urlPatterns={"/staff-appointmentdetail"})
public class Appointmentdetail extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("view/staff/content/Appointmentdetails.jsp").forward(request, response);
    } 
