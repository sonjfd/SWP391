...
public class MedicalRecords {
    ...
    public MedicalRecords(int id, Pet pet, Doctor doctor, Appointment appointment, String diagnosis, String treatment, Date reExamDate, String attachments, Date createDate, Date updateDate) {
        this.id = id;
        this.pet = pet;
        this.doctor = doctor;
