...
public class DashboardDAO {
    ...
    public static void main(String[] args) {
        try {
            ...
            DashboardData dashboardData = dao.getDashboardData();
            System.out.println("Total Pets: " + dashboardData.getTotalPets());
            System.out.println("Total Revenue: " + dashboardData.getTotalRevenue());
            System.out.println("Total Appointments: " + dashboardData.getTotalAppointments());
            System.out.println("Total Users: " + dashboardData.getTotalUsers());
            System.out.println("Total Doctors: " + dashboardData.getTotalDoctors());
            System.out.println("Total Nurses: " + dashboardData.getTotalNurses());

            // Test getAppointmentReportData
            AppointmentReportData reportData = dao.getAppointmentReportData(7);
            System.out.println("Revenue Dates: " + reportData.getRevenueDates());
            System.out.println("Revenues: " + reportData.getRevenues());
            System.out.println("Appointment Dates: " + reportData.getAppointmentDates());
            System.out.println("Appointment Counts: " + reportData.getAppointmentCounts());
