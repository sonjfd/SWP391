...
// * @author ASUS
// */
//@WebFilter(filterName = "FilterPage", urlPatterns = {"/*"})
...
//            || uri.endsWith(".ttf") || uri.contains("/assets/") || uri.contains("/static/")||uri.contains("/tinymce/")) {
...
//        if (!uri.contains("/doctor")&&!uri.contains("/staff")&&!uri.contains("/nurse")&&!uri.contains("/admin")) {
//            chain.doFilter(request, response);
//            return;
//        }
