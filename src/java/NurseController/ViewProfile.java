 ...
 */
@MultipartConfig
@WebServlet(name="ViewProfile", urlPatterns={"/nurse-viewprofile"})
public class ViewProfile extends HttpServlet {
  ...
  @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("view/nurse/content/NurseProfile.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("nurse-viewprofile");
