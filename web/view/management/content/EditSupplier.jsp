...
<body class="container py-4">
    ...
    <form action="${pageContext.request.contextPath}/editSupplier" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="supplier_name" id="supplier_name" class="form-control" maxlength="50" value="<%= supplier.getSupplierName() %>" required>
            <div id="supplier_nameError" class="text-danger" style="display:none;"></div>
        </div>

        <div class="mb-3">
            <label>Contact Name: <span class="text-danger">*</span></label>
            <input type="text" name="contact_name" id="contact_name" class="form-control" maxlength="50" value="<%= supplier.getContactName() %>" required>
            <div id="contact_nameError" class="text-danger" style="display:none;"></div>
        </div>

        <div class="mb-3">
            <label>Phone: <span class="text-danger">*</span></label>
            <input type="text" name="phone" id="phone" class="form-control" maxlength="50" value="<%= supplier.getPhone() %>" required>
            <div id="phoneError" class="text-danger" style="display:none;"></div>
        </div>

        <div class="mb-3">
            <label>Email: <span class="text-danger">*</span></label>
            <input type="email" name="email" id="email" class="form-control" maxlength="50" value="<%= supplier.getEmail() %>" required>
            <div id="emailError" class="text-danger" style="display:none;"></div>
        </div>

        <div class="mb-3">
            <label>Address: <span class="text-danger">*</span></label>
            <input type="text" name="address" id="address" class="form-control" maxlength="100" value="<%= supplier.getAddress() %>" required>
    ...
    <script>
        ...
        function validateTextField(id, fieldName, maxLength) {
            ...
            if (val.length > maxLength) {
                showError(id, `${fieldName} không được vượt quá ${maxLength} ký tự!`);
                return false;
            }
            showError(id, '');
            return true;
