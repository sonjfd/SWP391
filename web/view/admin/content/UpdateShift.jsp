            ...
            <div class="form-container">
                ...
                <form id="updateShiftForm" action="${pageContext.request.contextPath}/updateshift" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" value="${shift.name}" maxlength="50">
                        <div id="nameError" class="error-message"></div>
                    </div>
                    <div class="form-group">
                        <label for="start_time">Thời gian bắt đầu:</label>
                        <input type="time" id="start_time" name="start_time" value="${shift.start_time != null ? shift.start_time : ''}">
                        <div id="startTimeError" class="error-message"></div>
                    </div>
                    <div class="form-group">
                        <label for="end_time">Thời gian kết thúc:</label>
                        <input type="time" id="end_time" name="end_time" value="${shift.end_time != null ? shift.end_time : ''}">
