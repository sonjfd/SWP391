...
<html lang="en">
    ...
    <head>
        ...
        <title>Update Staff/Doctor Account</title>
        <style>
            body {
        ...
        <div class="container-fluid">
            <div class="layout-specing">
                ...
                <div class="form-container">
                    <h2>Update Staff/Doctor Account</h2>
                    ...
                    <form id="updateForm" action="updateaccount" method="post" onsubmit="return validateForm()">
                        ...
                        <div class="form-group">
                            ...
                            <select id="role_id" name="role_id" >
                                <option value="4" ${user.role.id == 4 ? 'selected' : ''}>Staff</option>
                                <option value="3" ${user.role.id == 3 ? 'selected' : ''}>Doctor</option>
                            </select>
                        </div>
                        <div class="form-group">
