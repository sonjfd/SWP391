    ...
    <nav class="mt-3 d-flex justify-content-center">
        <ul class="pagination">
            <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                <a class="page-link" href="admin-product?page=${currentPage - 1}${not empty param.keyword ? '&keyword=' + param.keyword : ''}">Trước</a>
            </li>

            <c:forEach var="i" begin="1" end="${totalPages}">
                <li class="page-item ${i == currentPage ? 'active' : ''}">
                    <a class="page-link" href="admin-product?page=${i}${not empty param.keyword ? '&keyword=' + param.keyword : ''}">${i}</a>
                </li>
            </c:forEach>

            <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                <a class="page-link" href="admin-product?page=${currentPage + 1}${not empty param.keyword ? '&keyword=' + param.keyword : ''}">Sau</a>
            </li>
        </ul>
    </nav>
</div>
