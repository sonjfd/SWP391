<%-- 
    ...
    Author     : Grok
    Description: Role management page for SWP391, styled like Admin.jsp
--%>
        ...
        <table>
            ...
            <c:forEach var="role" items="${roles}" varStatus="counter">
                <tr>
                    ...
                    <td>${role.name}</td>
                    <td>
                        <a href="${pageContext.request.contextPath}/admin-update-role?id=${role.id}" class="action-btn edit-btn">Sửa</a>
                        <form method="post" action="${pageContext.request.contextPath}/admin-delete-role" style="display:inline;">
