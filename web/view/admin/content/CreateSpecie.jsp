...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Pet24h - Tạo loài mới</title>
        ...
        <style>
            ...
            .main-wrapper {
                ...
                align-items: center;
                padding: 20px;
                min-height: calc(100vh - 70px); /* Trừ chiều cao header (giả sử 70px) */
            }
                    ...
                    <div class="col-lg-12">
                        <form id="createSpecieForm" method="post" action="admin-create-specie" enctype="multipart/form-data">
                            ...
                            <div class="button-group">
                                <button type="submit" class="btn-custom btn-submit">Tạo loài</button>
