...
<head>
    <meta charset="UTF-8">
    <title>Pet24h - Chuẩn Đoán Sơ Bộ</title>
...
<body>
    <div class="container-fluid">
        <div class="diagnosis-tab-wrapper">
            ...
            <form method="post" action="doctor-save-preliminary-diagnosis" id="formDiagnosis" novalidate autocomplete="off">
                <div class="mb-3">
...
if (check) {
    ...
    document.getElementById('saveEditDiagnosisBtn').addEventListener('click', function () {
        ...
        if (valid) {
            ...
            fetch('./doctor-save-edited-diagnosis', {
                method: 'POST',
                body: formData
            })
                .then(response => response.json())
