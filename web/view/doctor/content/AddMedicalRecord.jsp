...
<div id="medicalRecordFormContainer">
  <form method="post" action="add-medical-record" id="medicalRecordForm" enctype="multipart/form-data">
...
if (rec.appointmentStatus.toLowerCase() !== 'completed') {
  actionButtons +=
    '<a href="edit-medical-record?id=' + rec.id + '" class="me-2 text-primary" title="Sửa">' +
...
tbody.appendChild(tr);
    ...
    form.addEventListener('submit', function(e) {
        ...
        // Validate đơn giản phía client (có thể nâng cấp sau)
        let valid = true;
